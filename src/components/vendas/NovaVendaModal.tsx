...
export function NovaVendaModal({ open, onOpenChange, onSuccess }: NovaVendaModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.id_unico || !formData.numero_pedido || !formData.sku_produto) {
      toast({
    ...
    try {
      ...
      toast({
        ...
        description: "A venda foi adicionada com sucesso ao histórico.",
      });
